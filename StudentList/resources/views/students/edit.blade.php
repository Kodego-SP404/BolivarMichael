...
<header class="mt-5 max-w-lg mx-auto">
   <a href="#">
      <h1 class="text-4xl font-bold text-white text-center mt-20"> Edit {{$student->first_name }} {{$student->last_name }}</h1>
   </a>
</header>
<main class="bg-black bg-opacity-50 max-w-lg mx-auto p-8 my-10 rounded-lg shadow-2xl">
   ...
   <section class="mt-10">
      ...
      <form action="/student/{{$student->id}}" method="POST" class="flex flex-col">
         ...
         <button type="submit" class="bg-amber-400 hover:bg-amber-300 text-gray-700 font-bold py-2 rounded shadow-lg hover:shadow-xl transitionduration-200" type="submit">Update</button>
