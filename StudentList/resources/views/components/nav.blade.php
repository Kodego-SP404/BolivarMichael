{{-- <nav x-data="{open:false}" class="bg-gray-800 bg-opacity-50 fixed w-full z-20 top-0 left-0 border-gray-200 px-2 sm:px-4 py-2.5 text-white">
...
<nav x-data="{showMenu : false}" class="bg-gray-800 bg-opacity-50 fixed w-full z-20 top-0 left-0 border-gray-200 px-2 sm:px-4 py-2.5 text-white">
   <div class="container flex flex-wrap justify-between items-center">
       ...
       <button @click="showMenu = !showMenu" class="block md:hidden rounded hover:border focus:border focus:bg-gray-400 " type="button" aria-controls="navbar-main" aria-expanded="false" aria-label="Toggle navigation">
         <svg class="fill-current text-amber-400" xmlns="http://www.w3.org/2000/svg" height="24" width="24"><path d="M3 18v-2h18v2Zm0-5v-2h18v2Zm0-5V6h18v2Z"/></svg>
       </button>
       <!-- Nav Links-->
